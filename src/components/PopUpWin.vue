  ...
  <div v-if="visible" class="popup-overlay">
    <div class="popup-box">
      ...
      <div class="contenido-popup">
        <p>Lograste completar el reto</p>
        <p class="mensaje-final">en 60 segundos</p>
        <p>¡Disfruta de tu premio al instante!</p>
      </div>
...
.titulo-popup {
  ...
  color: #932786;  
  margin-bottom: 2vh;
  font-family: 'HGBlack', sans-serif;
}
